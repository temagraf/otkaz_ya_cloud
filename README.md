# Домашнее задание к занятию «Отказоустойчивость в облаке» - Яковлев Артем
...
![10-7-1](./img/10-7-1.png)
![10-7-2](./img/10-7-2.png)
![10-7-4](./img/10-7-4.png)

*3. Скриншот страницы, которая открылась при запросе IP-адреса балансировщика.*
![10-7-3](./img/10-7-3.png)
